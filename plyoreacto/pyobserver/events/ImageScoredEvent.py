...
class ImageScoredEvent(object):
    ...
    def Scores(self, j):
        ...
        if o != 0:
            ...
            from events.ImageLabelScore import ImageLabelScore
            obj = ImageLabelScore()
...
def ImageScoredEventStart(builder): builder.StartObject(2)
def Start(builder):
    return ImageScoredEventStart(builder)
def ImageScoredEventAddImageUuid(builder, imageUuid): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(imageUuid), 0)
def AddImageUuid(builder, imageUuid):
    return ImageScoredEventAddImageUuid(builder, imageUuid)
def ImageScoredEventAddScores(builder, scores): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(scores), 0)
