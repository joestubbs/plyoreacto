...
pub mod events {
    ...
    impl<'a> NewImageEvent<'a> {
        ...
        pub const VT_IMAGE_FORMAT: flatbuffers::VOffsetT = 6;
    ...
    impl<'a> ImageScoredEvent<'a> {
        pub const VT_IMAGE_UUID: flatbuffers::VOffsetT = 4;
        pub const VT_SCORES: flatbuffers::VOffsetT = 6;
    ...
    impl<'a> Default for ImageStoredEventArgs<'a> {
        #[inline]
        fn default() -> Self {
            ImageStoredEventArgs { image_uuid: None }
        }
    }
    ...
    impl<'a> Default for ImageDeletedEventArgs<'a> {
        #[inline]
        fn default() -> Self {
            ImageDeletedEventArgs { image_uuid: None }
        }
    }
